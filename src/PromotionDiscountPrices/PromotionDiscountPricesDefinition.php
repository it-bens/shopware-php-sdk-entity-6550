...
{
    public const string ENTITY_NAME = 'promotion_discount_prices';
    ...
    public function getSchema(): Schema
    {
        return new Schema('promotion_discount_prices', new PropertyCollection([
            ...
            new Property('price', 'float', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
                new Flag('required', 1),
            ]), []),
            new Property('promotionDiscount', 'association', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
            ]), [
