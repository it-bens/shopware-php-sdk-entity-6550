...
{
    public const string ENTITY_NAME = 'media_thumbnail_size';
    ...
    public function getSchema(): Schema
    {
        return new Schema('media_thumbnail_size', new PropertyCollection([
            ...
            new Property('width', 'int', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
                new Flag('required', 1),
            ]), []),
            new Property('height', 'int', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
                new Flag('required', 1),
            ]), []),
            new Property('mediaFolderConfigurations', 'association', new FlagCollection([
