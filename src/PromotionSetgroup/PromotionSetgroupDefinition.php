...
{
    public const string ENTITY_NAME = 'promotion_setgroup';
    ...
    public function getSchema(): Schema
    {
        return new Schema('promotion_setgroup', new PropertyCollection([
            ...
            new Property('packagerKey', 'string', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
                new Flag('required', 1),
            ]), []),
            ...
            new Property('setGroupRules', 'association', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
