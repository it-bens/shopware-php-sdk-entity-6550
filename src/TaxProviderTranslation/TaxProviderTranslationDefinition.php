...
{
    public const string ENTITY_NAME = 'tax_provider_translation';
    ...
    public function getSchema(): Schema
    {
        return new Schema('tax_provider_translation', new PropertyCollection([
            ...
            new Property('taxProviderId', 'uuid', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
            ...
            new Property('taxProvider', 'association', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
            ]), [
                'entity' => 'tax_provider',
                'referenceField' => 'id',
