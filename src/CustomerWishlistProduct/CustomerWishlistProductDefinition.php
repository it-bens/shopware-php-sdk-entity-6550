...
{
    public const string ENTITY_NAME = 'customer_wishlist_product';
    ...
    public function getSchema(): Schema
    {
        return new Schema('customer_wishlist_product', new PropertyCollection([
            ...
            new Property('wishlistId', 'uuid', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
                new Flag('required', 1),
            ]), []),
            new Property('wishlist', 'association', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
            ]), [
