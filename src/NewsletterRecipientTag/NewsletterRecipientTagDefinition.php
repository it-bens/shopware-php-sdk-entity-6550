...
{
    public const string ENTITY_NAME = 'newsletter_recipient_tag';
    ...
    public function getSchema(): Schema
    {
        return new Schema('newsletter_recipient_tag', new PropertyCollection([
            new Property('newsletterRecipientId', 'uuid', new FlagCollection([
            ...
            new Property('newsletterRecipient', 'association', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
            ]), [
