...
{
    public const string ENTITY_NAME = 'property_group_translation';
    ...
    public function getSchema(): Schema
    {
        return new Schema('property_group_translation', new PropertyCollection([
            ...
            new Property('propertyGroupId', 'uuid', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
            ...
            new Property('propertyGroup', 'association', new FlagCollection([
