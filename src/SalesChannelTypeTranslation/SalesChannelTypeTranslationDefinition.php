...
{
    public const string ENTITY_NAME = 'sales_channel_type_translation';
    ...
    public function getSchema(): Schema
    {
        return new Schema('sales_channel_type_translation', new PropertyCollection([
            ...
            new Property('salesChannelTypeId', 'uuid', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
            ...
            new Property('salesChannelType', 'association', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
            ]), [
