...
{
    public const string ENTITY_NAME = 'product_manufacturer_translation';
    ...
    public function getSchema(): Schema
    {
        return new Schema('product_manufacturer_translation', new PropertyCollection([
            ...
            new Property('productManufacturerId', 'uuid', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
            ...
            new Property('productManufacturer', 'association', new FlagCollection([
