...
{
    public const string ENTITY_NAME = 'import_export_profile_translation';
    ...
    public function getSchema(): Schema
    {
        return new Schema('import_export_profile_translation', new PropertyCollection([
            ...
            new Property('importExportProfileId', 'uuid', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
            ...
            new Property('importExportProfile', 'association', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
            ]), [
