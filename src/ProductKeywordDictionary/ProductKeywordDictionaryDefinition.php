...
{
    public const string ENTITY_NAME = 'product_keyword_dictionary';
    ...
    public function getSchema(): Schema
    {
        return new Schema('product_keyword_dictionary', new PropertyCollection([
            ...
            new Property('keyword', 'string', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
                new Flag('required', 1),
            ]), []),
            new Property('reversed', 'string', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
                new Flag('computed', 1),
            ]), []),
