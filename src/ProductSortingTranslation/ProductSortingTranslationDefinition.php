...
{
    public const string ENTITY_NAME = 'product_sorting_translation';
    ...
    public function getSchema(): Schema
    {
        return new Schema('product_sorting_translation', new PropertyCollection([
            ...
            new Property('productSortingId', 'uuid', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
            ...
            new Property('productSorting', 'association', new FlagCollection([
