...
{
    public const string ENTITY_NAME = 'cms_slot_translation';
    ...
    public function getSchema(): Schema
    {
        return new Schema('cms_slot_translation', new PropertyCollection([
            ...
            new Property('cmsSlotId', 'uuid', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
            ...
            new Property('cmsSlot', 'association', new FlagCollection([
            ...
            new Property('cmsSlotVersionId', 'uuid', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
                new Flag('primary_key', 1),
                new Flag('required', 1),
            ]), []),
