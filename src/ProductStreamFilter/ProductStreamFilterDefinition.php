...
{
    public const string ENTITY_NAME = 'product_stream_filter';
    ...
    public function getSchema(): Schema
    {
        return new Schema('product_stream_filter', new PropertyCollection([
            ...
            new Property('operator', 'string', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
            ]), []),
            ...
            new Property('queries', 'association', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
