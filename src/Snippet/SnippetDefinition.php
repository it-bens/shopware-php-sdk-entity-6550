...
{
    public const string ENTITY_NAME = 'snippet';
    ...
    public function getSchema(): Schema
    {
        return new Schema('snippet', new PropertyCollection([
            ...
            new Property('setId', 'uuid', new FlagCollection([
            ...
            new Property('translationKey', 'string', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
                new Flag('required', 1),
            ...
            new Property('value', 'text', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
                new Flag('required', 1),
            ...
            new Property('set', 'association', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
            ]), [
                'entity' => 'snippet_set',
                'referenceField' => 'id',
