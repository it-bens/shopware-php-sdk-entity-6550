...
{
    public const string ENTITY_NAME = 'mail_template_type';
    ...
    public function getSchema(): Schema
    {
        return new Schema('mail_template_type', new PropertyCollection([
            ...
            new Property('availableEntities', 'json_object', new FlagCollection([
            ...
            new Property('mailTemplates', 'association', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
            ...
            new Property('templateData', 'json_object', new FlagCollection([
                new Flag('read_protected', [['Shopware\Core\Framework\Api\Context\AdminApiSource']]),
            ]), [
                'properties' => json_decode('[]', true),
            ]),
