...
{
    public const string ENTITY_NAME = 'product_cross_selling_translation';
    ...
    public function getSchema(): Schema
    {
        return new Schema('product_cross_selling_translation', new PropertyCollection([
            ...
            new Property('productCrossSellingId', 'uuid', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
            ...
            new Property('productCrossSelling', 'association', new FlagCollection([
