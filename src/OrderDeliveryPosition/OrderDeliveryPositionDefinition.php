...
{
    public const string ENTITY_NAME = 'order_delivery_position';
    ...
    public function getSchema(): Schema
    {
        return new Schema('order_delivery_position', new PropertyCollection([
            ...
            new Property('orderDeliveryId', 'uuid', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
                new Flag('required', 1),
            ]), []),
            new Property('orderDeliveryVersionId', 'uuid', new FlagCollection([
                new Flag('read_protected', [[
                    'Shopware\Core\Framework\Api\Context\AdminApiSource', 'Shopware\Core\Framework\Api\Context\SalesChannelApiSource'],
                ]),
                new Flag('required', 1),
            ...
            new Property('orderDelivery', 'association', new FlagCollection([
